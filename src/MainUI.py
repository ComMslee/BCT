...
class Ui_BCT(object):
    def setupUi(self, BCT):
        ...
        self.factory_temp_stop.setGeometry(QRect(10, 150, 101, 71))
        ...
        self.factory_temp_start.setGeometry(QRect(10, 10, 101, 71))
        ...
        self.factory_temp_push.setGeometry(QRect(110, 100, 101, 31))
        ...
        self.factory_temp_value.setGeometry(QRect(10, 100, 101, 31))
